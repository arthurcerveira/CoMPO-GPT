...
do
    ...
    #print command
    echo "python3 cMolGPT/main.py --mode infer --target ${i} --path models_cMolGPT/finetune.h5 \
                          --num_molecules 30000 --output_path generated_molecules/${targets[i]}.csv"

    python3 cMolGPT/main.py --mode infer --target ${i} --path models_cMolGPT/finetune.h5 \
                    --num_molecules 30000 --output_path generated_molecules/${targets[i]}.csv
done
